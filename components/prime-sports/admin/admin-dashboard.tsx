                  ...
                  >
                    <button type="button" className="w-full px-4 py-3 text-left" onClick={() => setActiveId(item.id)}>
                      <div className="mb-1 flex items-baseline justify-between gap-2">
                        ...
                        <span className="text-[11px] [font-family:var(--font-mono)] font-medium opacity-60 tabular-nums">{item.ref}</span>
                      </div>
                      <div className="flex flex-wrap gap-2 text-[11px] opacity-60">
                        ...
                        <span className="rounded border border-border bg-surface-muted px-1.5 py-0.5 [font-family:var(--font-mono)] font-semibold tabular-nums">{item.time}</span>
            ...
            {activeSubmission ? (
              <>
                <div className="mb-5 flex flex-wrap items-start justify-between gap-4 border-b border-border pb-4">
                  <div>
                    <h3 className="[font-family:var(--font-heading)] text-[22px] font-extrabold uppercase tracking-[0.06em]">{activeSubmission.name}</h3>
                    <div className="mt-1 text-[12px] [font-family:var(--font-mono)] font-medium opacity-60 tabular-nums">Ref: {activeSubmission.ref}</div>
                  </div>
                  ...
                  <div>
                    <dl className="grid grid-cols-2 gap-x-4 gap-y-3 max-[640px]:grid-cols-1">
                      ...
                      <div>
                        ...
                        <dd className="m-0 text-[13px] [font-family:var(--font-mono)] font-semibold tabular-nums">{activeSubmission.time}</dd>
                      </div>
                      <div>
                        <dt className={primeMetaLabelClass}>Amount</dt>
                        <dd className="m-0 text-[13px] [font-family:var(--font-mono)] font-semibold tabular-nums">{activeSubmission.amount}</dd>
                      </div>
                      <div>
